      ...
      <div class="mx-auto px-6">
        ...
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
          <div v-for="product in products" :key="product.id">
            <router-link class="text-gray-800" :to="{name: 'Item', params: {id: product.id}}">
            ...
            <button :disabled="!product.inventory" @click="addProductToCart(product)" class="ml-60 -mt-5 p-2 rounded-full bg-blue-600 text-white mx-5 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
